export const providerCatalog = [
  { id: "antigravity", name: "Antigravity", icon: "antigravity", integrated: true },
  ...
  { id: "devin", name: "Devin", icon: "devin", integrated: true },
  { id: "factory", name: "Factory", icon: "factory", integrated: false },
  { id: "grok", name: "Grok", icon: "grok", integrated: false },
  { id: "openrouter", name: "OpenRouter", icon: "openrouter", integrated: false },
