...
cpSync(resolve(root, "localization"), resolve(dist, "localization"), { recursive: true });

console.log("package.json, icon.svg, screenshots, and localization copied to dist/");
