import { ChevronDown, FolderOpen, Minus, Plus } from "lucide-react";
...
export function FileSection({
  ...
  return (
    <section>
      <header className="sticky top-0 z-10 flex h-[30px] items-center gap-1.5 bg-background pl-2 pr-1">
        <button
          type="button"
          onClick={toggle}
        ...
        <div className="ml-auto flex items-center text-muted-foreground">
          <Button variant="ghost" size="icon-sm" className="size-[18px]" title="View as tree">
            <FolderOpen size={ICON_SIZE.row} strokeWidth={ICON_STROKE} />
          </Button>
